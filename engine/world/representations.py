...
_RULES: list[tuple[frozenset[str], RepType, tuple[RepType, ...], str]] = [
    ...
    (frozenset({"monty", "hall", "goat", "door", "switch", "prize",
                "game show"}),
     RepType.EXPERIMENT, (RepType.MATHEMATICAL_TRANSFORMATION,),
     "game-show probability topics: experiment (run the game) + math"),
